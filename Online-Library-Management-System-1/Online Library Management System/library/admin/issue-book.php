...
include('includes/config.php');
    ...
    //$user = $_SESSION['user'];
    $error = 'false';
    $selectquery = "select * from book_request where status = 'pending'";
                                    ...
                                    <tbody>
                                      <?php 
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo($print['request_made_on'])?> </td>
                                            <td class="center">

                                              <a href="issue.php?studentid=<?php echo($print['student_id']) ?>&&ISBN=<?php echo($print['ISBN'])?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Accept</button></a> 
