...
if(isset($_POST['password'])){
    extract($_POST);
    $email = $_SESSION['user'];
    $selectquery = "select * from admin where UserName = '$email'";
    $selectqueryresult = mysqli_query($con, $selectquery) or die(mysqli_error($con));
    $userinfo = mysqli_fetch_array($selectqueryresult);
    if($password == $userinfo['Password']){
       $updatequery = "UPDATE admin SET Password = '$newpassword' WHERE UserName = '$email'"; 
...
<!--LOGIN PANEL START--> 
    <?php if($success=='true'){?>
    <span style="color:green">Password Changed!!!!!</span>
    <?php } ?>
<div class="row">
