...
#books
 ...
 $books = mysqli_num_rows($queryresult);
#users
  $query = "select * from students";
 $queryresult = mysqli_query($con, $query)or die(mysqli_error($con)) ;
 $students = mysqli_num_rows($queryresult);   
#category
   $query = "select * from category";
 $queryresult = mysqli_query($con, $query)or die(mysqli_error($con)) ;
 $categories = mysqli_num_rows($queryresult);        
#authors    
   $query = "select * from authors";
 $queryresult = mysqli_query($con, $query)or die(mysqli_error($con)) ;
 $authors = mysqli_num_rows($queryresult); 
    
#books issued
    $query = "select * from issued_books";
 $queryresult = mysqli_query($con, $query)or die(mysqli_error($con)) ;
 $issuedbooks = mysqli_num_rows($queryresult);
    
#books retuned
    $query = "select * from issued_books where status='returned'";
 $queryresult = mysqli_query($con, $query)or die(mysqli_error($con)) ;
 $returnedbooks = mysqli_num_rows($queryresult);           
}else{ ?>
  <script>
