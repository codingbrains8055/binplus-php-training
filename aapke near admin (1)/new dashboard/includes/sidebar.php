<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#page-layouts" aria-expanded="false" aria-controls="page-layouts"> <img class="menu-icon" src="images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">Coupon</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="page-layouts">.
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="add-coupon.php">Add Coupon</a></li>
                <li class="nav-item"> <a class="nav-link" href="manage-coupon.php">Manage Coupon</a></li>
                <!-- <li class="nav-item"> <a class="nav-link" href="">Horizontal Menu</a></li>
                <li class="nav-item"> <a class="nav-link" href="">Horizontal Menu 2</a></li> -->
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link"  href="order.php" aria-expanded="false" aria-controls="page-layouts"> <img class="menu-icon" src="images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">Order</span><i class="menu-arrow"></i></a>
          
          </li>
          <li class="nav-item">
            <a class="nav-link"  href="user.php" aria-expanded="false" aria-controls="page-layouts"> <img class="menu-icon" src="images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">User</span><i class="menu-arrow"></i></a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/layout/horizontal-menu-2.html">Horizontal Menu 2</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item"> <a class="nav-link" href="pages/widgets.html"> <img class="menu-icon" src="images/menu_icons/08.png" alt="menu icon"> <span class="menu-title">Widgets</span> </a> </li>
          <li class="nav-item">
          ...
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/popups.html"> <img class="menu-icon" src="images/menu_icons/20.png" alt="menu icon"> <span class="menu-title">Popups</span> </a> </li>
          <li class="nav-item"> <a class="nav-link" href="pages/ui-features/notifications.html"> <img class="menu-icon" src="images/menu_icons/13.png" alt="menu icon"> <span class="menu-title">Notifications</span> </a> </li>
          <li class="nav-item">
          ...
          <li class="nav-item"> <a class="nav-link" href="pages/documentation.html"> <img class="menu-icon" src="images/menu_icons/05.png" alt="menu icon"> <span class="menu-title">Documentation</span> </a> </li>
          <li class="nav-item">
