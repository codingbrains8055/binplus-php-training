...
//count users
$course_query = "select * from courses RIGHT OUTER JOIN user_course ON courses.course_id = user_course.course_id LEFT OUTER JOIN user ON user_course.user_id = user.user_id";
